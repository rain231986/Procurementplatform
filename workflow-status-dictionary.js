...
export const WORKFLOW_STATUS_LABELS = Object.freeze({
  ...
  PURCHASABLE: "可採購",
  INACTIVE: "已停用",
  PENDING_SOURCE_APPROVAL: "待調出門市核准",
  RETURNED: "退回修改",
  PARTIALLY_SHIPPED: "部分出貨",
  REJECTED: "已拒絕",
  PENDING_STORE_MANAGER_APPROVAL: "待門市店長核准",
  PENDING_WAREHOUSE_APPROVAL: "待總倉核准",
  SHIPPED_TO_WAREHOUSE: "已寄回總倉",
  RECEIVED_BY_WAREHOUSE: "總倉已收貨",
  RETURNED_TO_STORE: "待門市重新簽收",
  PENDING_PURCHASING_REVIEW: "待採購審核",
  PENDING_SUPPLIER_CONFIRMATION: "待廠商確認",
  SUPPLIER_CONFIRMED: "廠商已確認",
  SHIPPED_TO_SUPPLIER: "已寄給廠商",
  WAITING_RESOLUTION: "等待退款／換貨",
  PARTIALLY_RESOLVED: "部分完成",
  SAFETY_STOCK_TRANSFER_LIMIT: "低於安全庫存",
